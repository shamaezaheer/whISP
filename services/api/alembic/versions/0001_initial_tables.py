...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "active", "suspended", "terminated", name="franchisee_status"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("owner", "manager", "support", name="franchisee_user_role"), nullable=False, server_default="support"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("active", "suspended", "expired", "pending", "terminated", name="subscriber_status"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("plan_id", UUID(as_uuid=True), sa.ForeignKey("plans.id", ondelete="SET NULL")),
        sa.Column("gateway", sa.Enum("bkash", "nagad", "sslcommerz", "manual", name="payment_gateway"), nullable=False),
        ...
        sa.Column("currency", sa.String(3), nullable=False, server_default="BDT"),
        sa.Column("status", sa.Enum("initiated", "pending", "completed", "failed", "cancelled", "refunded", name="payment_status"), nullable=False, server_default="initiated"),
    ...
    op.create_table(
        ...
        sa.Column("channel", sa.Enum("sms", "email", "push", "in_app", name="notification_channel"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("command_type", sa.Enum("disconnect", "coa", "rate_limit", name="coa_command_type"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("category", sa.Enum("billing", "connectivity", "speed", "installation", "other", name="ticket_category"), nullable=False, server_default="other"),
        sa.Column("priority", sa.Enum("low", "medium", "high", "critical", name="ticket_priority"), nullable=False, server_default="medium"),
        sa.Column("status", sa.Enum("open", "in_progress", "pending_customer", "resolved", "closed", name="ticket_status"), nullable=False, server_default="open"),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("subscriber_id", UUID(as_uuid=True), sa.ForeignKey("subscribers.id", ondelete="CASCADE"), nullable=False),
        sa.Column("partner", sa.Enum("chorki", "hoichoi", name="ott_partner"), nullable=False),
        sa.Column("partner_user_id", sa.String(255)),
        sa.Column("partner_subscription_id", sa.String(255)),
        sa.Column("status", sa.Enum("active", "revoked", "expired", name="ott_status"), nullable=False, server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("actor_type", sa.Enum("admin", "franchisee", "subscriber", "system", name="actor_type"), nullable=False),
